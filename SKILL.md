---
name: xxd-panel-217
description: "Create Panel 217 raster artwork: 摄影与数码混合媒介拼贴海报. Use when the user invokes xxd-panel-217 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-217/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-217-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
